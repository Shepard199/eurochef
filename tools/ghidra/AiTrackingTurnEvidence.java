...
public class AiTrackingTurnEvidence extends GhidraScript {
    ...
    @Override public void run() throws Exception {
        ...
        dump(0x004530B0L,d);
        println(String.format("DAT_005E1FA4 bits=%08X float=%f", getInt(toAddr(0x005E1FA4L)), getFloat(toAddr(0x005E1FA4L))));
        d.dispose();
    }
}
