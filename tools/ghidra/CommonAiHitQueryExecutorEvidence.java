...
public class CommonAiHitQueryExecutorEvidence extends GhidraScript {
    ...
    @Override public void run() throws Exception {
        ...
        for (long a : new long[]{
            0x004254F0L, 0x00425690L, 0x00425990L, 0x004511E0L,
            0x00451350L, 0x004517A0L, 0x00453160L, 0x00455DC0L,
            0x00455DD0L
        }) dump(a, d);
        d.dispose();
    }
