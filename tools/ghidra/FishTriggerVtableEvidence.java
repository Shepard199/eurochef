...
public class FishTriggerVtableEvidence extends GhidraScript {
    private Function ensure(long raw)throws Exception{
        Address a=toAddr(raw);Function f=getFunctionAt(a);
    ...
    @Override public void run()throws Exception{
        ...
        dump(0x0047DEC0L,d);
        // ctor writes Fish vtable; known after decompile, also dump likely base Monster trigger ctor.
        dump(0x0047DBA0L,d);
        d.dispose();
    }
}
