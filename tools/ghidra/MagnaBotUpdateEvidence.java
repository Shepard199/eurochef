...
public class MagnaBotUpdateEvidence extends GhidraScript {
 ...
 @Override public void run() throws Exception{DecompInterface d=new DecompInterface();d.openProgram(currentProgram);dc(0x00464810L,d);dc(0x00464D20L,d);dc(0x0045AEB0L,d);d.dispose();}
}