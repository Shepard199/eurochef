...
public class MonsterFishCreatorSlotsEvidence extends GhidraScript {
 ...
 @Override public void run() throws Exception {
  long vt=0x005E84F0L;
  long a=ptr(vt+0x10c), b=ptr(vt+0x110);
  println(String.format("VTABLE 0x%08X +10C=0x%08X +110=0x%08X",vt,a,b));
  DecompInterface d=new DecompInterface(); d.openProgram(currentProgram);
  recover(a,"tmp_MonsterFish_10C",d);
  recover(b,"tmp_MonsterFish_110",d);
  d.dispose();
 }
}