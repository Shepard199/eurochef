...
set "OUTPUT=D:\GitHubHome\Robots\Robot_one_click\_tools\eurochef-main_legacy\tools\ghidra\ExplosionRuntimeEvidence.txt"
set "GHIDRA_JAVA_OPTIONS=-Duser.name=max19"
call "%GHIDRA%" "%PROJECT_DIR%" robots -process Robots.exe -noanalysis -readOnly -scriptPath "%SCRIPT_DIR%" -postScript ExplosionRuntimeEvidence.java >"%OUTPUT%" 2>&1
exit /b %ERRORLEVEL%
